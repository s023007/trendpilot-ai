...
# Generic shoes/footwear must mean something a shopper can actually wear.
...
SHOE_CONTEXT=re.compile(r'(?:\b(?:men|mens|men\x27s|women|womens|women\x27s|girl|girls|boy|boys|kid|kids|children|childrens|baby|unisex|casual|sport|sports|running|walking|hiking|work|safety|dress|formal|leather|canvas|fashion|athletic|tennis|basketball|soccer|football|golf|dance|ballet|winter|snow|platform|flat|beach|summer|breathable|slip resistant|non-slip|wide fit|wide foot)\b.{0,35}\bshoes?\b)|(?:\bshoes?\b.{0,35}\b(?:men|mens|women|womens|girl|girls|boy|boys|kid|kids|children|baby|unisex|casual|sport|sports|running|walking|hiking|work|safety|dress|formal|leather|canvas|fashion|athletic|tennis|basketball|soccer|football|golf|dance|ballet|winter|snow|platform|flat|beach|summer|breathable|slip resistant|non-slip|wide fit|wide foot|size)\b)',re.I)
BOOT_CONTEXT=re.compile(r'(?:\b(?:men|mens|women|womens|girl|girls|boy|boys|kid|kids|children|baby|unisex|work|safety|hiking|winter|snow|ankle|knee|combat|fashion|leather|rain|riding|cowboy|motorcycle)\b.{0,30}\bboots?\b)|(?:\bboots?\b.{0,30}\b(?:men|mens|women|womens|girl|girls|boy|boys|kid|kids|children|baby|unisex|work|safety|hiking|winter|snow|ankle|knee|combat|fashion|leather|rain|riding|cowboy|size)\b)',re.I)
...
FOOT_NEG=re.compile(r'\b(?:cold shoe|hot shoe|camera|camcorder|tripod|flash light|flashlight|photography|photo studio|backdrop|background|tv box|mini pc|dual boot|android|usb|wifi|led ring|phone|iphone|airpods?|earphones?|headphones?|watchband|watch band|bracelet|bottle openers?|wedding favors?|protective cases?|phone cases?|back cover|charging cover|silicone case|plastic case|shoe covers?|shoe racks?|shoe bags?|shoe boxes?|shoelaces?|shoe laces?|insoles?|outsoles?|shoe horns?|shoe brushes?|shoe trees?|shoe stretchers?|shoe dryers?|shoe machines?|shoe beating machine|shoe molding|shoe making|shoe lasts?|shoe repair|shoe glue|shoe charms?|shoe clips?|shoe buckles?|shoe decorations?|shoe accessories|pneumatic hammer|handheld hammer|tire maintenance|brake shoes?|snow blowers?|skid plates?|skid shoes?|guide shoes?|sliding shoes?|sanding shoes?|machine shoes?|elevator shoes?|rail shoes?|crawler shoes?|horseshoes?|horse shoes?|cv boots?|dust boots?|rack boots?|steering boots?|shift boots?|gear boots?|trunk boots?|boot gas|boot struts?|boot lids?|boot release|boot locks?|boot liners?|boot mats?|boot seals?|ball joint boots?|tie rod boots?|shock boots?|connector boots?|cable boots?|flooring installation|epoxy shoes?|temperature control iron|heel wedges?|heel lifts?|orthotics?|orthopedic inserts?|post[- ]?op|postoperative|walker boots?|walking boot braces?|medical boots?|ankle braces?|foot braces?|cast shoes?|fracture boots?|pressure relief boots?|fall management|patient|therapy|pain relief|single patient use)\b',re.I)
...
def payload(source,per_seller,kind):
    ...
    return {'version':'21.13.5','kind':kind,'generated_from':'data/v20-9/products/*.json','records_scanned':total,'seller_count':len(sellers),'packed_record_count':len(records),'counts':counts,'sellers':sellers,'records':records}
