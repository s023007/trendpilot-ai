...
def main() -> None:
    ...
    require("['NL']" in router_js or "'NL'" in router_js, 'Global locale router does not map Netherlands to nl-nl')
    ...
    print('PASS ticket landing QA: Dutch locale, exact seller links, Dutch modal, outbound tracking, locale router')
