...
- Arabic and English high-intent keyword groups are prepared.
- Exact and phrase match only; no broad positive match for the first test.
- Negative-keyword guardrails are prepared.
...
1. Winning exact-match keywords.
2. Winning phrase-match keywords.
3. Additional high-intent Saudi search terms from the Search terms report.
4. Time-of-day/device adjustments only after enough data.
5. Broader Gulf-country campaigns only as separate controlled tests with localized landing pages/currency presentation.
