...
exports.handler=async function(event){
  ...
  const hasExact=groups.some(g=>activeOffers(g).some(o=>exactEvidence(o,g)));
  const robots=(sellers&&hasExact)?"index,follow,max-image-preview:large":"noindex,follow,max-image-preview:large";
