...
function notFound() {
  return {statusCode:404,headers:{'content-type':'text/html; charset=utf-8','cache-control':'public, max-age=60','x-robots-tag':'noindex'},body:'<!doctype html><html><head><meta name="robots" content="noindex"><title>Product not found — TrendPilot</title><link rel="stylesheet" href="/css/shopper-v20-6-8-4.css?v=20.6.8.4"></head><body><main><h1>Product not found</h1><p><a href="/find/">Back to TrendPilot search</a></p></main><script defer src="/js/shopper-v20-6-8-4.js?v=20.6.8.4"></script></body></html>'};
}

function unavailable(err) {
  const message=esc(err?.message||'Product Preview is temporarily unavailable.');
  return {statusCode:503,headers:{'content-type':'text/html; charset=utf-8','cache-control':'no-store','x-robots-tag':'noindex'},body:`<!doctype html><html><head><meta name="robots" content="noindex"><title>Product Preview temporarily unavailable — TrendPilot</title><link rel="stylesheet" href="/css/shopper-v20-6-8-4.css?v=20.6.8.4"></head><body><main style="max-width:760px;margin:80px auto;padding:24px;font-family:system-ui"><h1>Product Preview is temporarily unavailable.</h1><p>${message}</p><p><a href="/find/?engine=${ENGINE}">Return to product search</a></p></main><script defer src="/js/shopper-v20-6-8-4.js?v=20.6.8.4"></script></body></html>`};
}
